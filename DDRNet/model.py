...
class DDRNet(nn.Module):
    def __init__(self, inchanel,backbone: str = None, num_classes: int = 2) -> None:
        super().__init__()
        planes, spp_planes, head_planes = [32, 64, 128, 256, 512], 128, 64

        self.conv1 = Stem(inchanel, planes[0])
...
if __name__ == '__main__':
    model = DDRNet(inchanel=14,num_classes=2)
